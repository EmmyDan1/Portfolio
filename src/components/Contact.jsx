...
const Contact = () => {
  return (
    <section
      ...
      id="contact"
    >
      <h2 className="lg:text-3xl md:text-2xl sm:text-xl text-lg font-bold text-gray-800 mb-12">
        Let's Get In Touch
      </h2>
      ...
      <form className="w-3/5">
        ...
        <button
          type="submit"
          className="mt-12 w-full bg-gray-800 py-2 px-4 text-white font-bold rounded-md hover:bg-orange-700"
        >
          Send Message
        </button>
      </form>
